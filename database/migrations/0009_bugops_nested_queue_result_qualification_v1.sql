-- BugOps runtime qualification correction V2.
-- Qualifies nested enqueue_work_v2 return columns in route/reopen paths.
...
BEGIN
  ...
  IF v_requested='CLOSED' THEN
    SELECT c.* INTO v_close FROM bt2.bug_closure_evidence c
