...
- `LANTERN_WOWSQL_OPERATOR_HANDSHAKE_V2.md`;
- `LANTERN_WOWSQL_READ_QUERIES_V2.md`;
- `LANTERN_WOWSQL_RUNTIME_CONTRACT_V2.md`;
- `LANTERN_WOWSQL_ACCEPTANCE_V2.md`.
...
2. projection preflight -> B0 -> payload -> B1 is performed using `LANTERN_WOWSQL_READ_QUERIES_V2.md`;
