...
3. Route binding: execute the projection preflight from `LANTERN_WOWSQL_READ_QUERIES_V1.md`. On WoWSQL free-shared PostgreSQL, the Project role reads `bt2_project_read`; it is intentionally denied direct `bt2` schema access.
