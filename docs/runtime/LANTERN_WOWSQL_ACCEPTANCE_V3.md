...
- `LANTERN_WOWSQL_OPERATOR_HANDSHAKE_V3.md`;
- `LANTERN_WOWSQL_READ_QUERIES_V3.md`;
- `LANTERN_WOWSQL_RUNTIME_CONTRACT_V3.md`;
- `LANTERN_WOWSQL_ACCEPTANCE_V3.md`.
...
2. projection preflight -> B0 -> payload -> B1 is performed using `LANTERN_WOWSQL_READ_QUERIES_V3.md`;
