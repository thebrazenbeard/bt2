# LANTERN_WOWSQL_OPERATOR_HANDSHAKE_V2
...
3. Route binding: execute the projection preflight from `LANTERN_WOWSQL_READ_QUERIES_V2.md`. On WoWSQL free-shared PostgreSQL, the Project role reads `bt2_project_read`; it is intentionally denied direct `bt2` schema access.
4. B0 cut: execute the B0 query from `LANTERN_WOWSQL_READ_QUERIES_V2.md`.
