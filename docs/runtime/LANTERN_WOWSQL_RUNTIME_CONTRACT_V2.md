# LANTERN_WOWSQL_RUNTIME_CONTRACT_V2
...
Follow `LANTERN_WOWSQL_OPERATOR_HANDSHAKE_V2.md` and `LANTERN_WOWSQL_READ_QUERIES_V2.md`.
...
Use `LANTERN_WOWSQL_ACCEPTANCE_V2.md` for installation and runtime-consumption acceptance.
