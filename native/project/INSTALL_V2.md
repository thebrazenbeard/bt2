...
## Project files
Install every required native Project file listed in `PROJECT_FILES_MANIFEST_V2.json`. The four Lantern WoWSQL files in V2 use the free-shared `bt2_project_read` projection and replace earlier direct-`bt2` read-contract copies.
