# BUILD TEAM TWO - NATIVE PROJECT INSTRUCTIONS V3
...
The `PROJECT LANTERN NATIVE RUNTIME V3` block below intentionally supersedes the prior V1 and V2 Lantern runtime blocks. For Lantern-specific behavior, follow this exact reviewed V3 block and its frozen source binding.
...
Current Lantern free-shared runtime package source binding: `thebrazenbeard/bt2@95def111331e63fc942628b95413f536cbc461f9` / tree `da6d21eb6b6d146251713211eae52f8c405b965b`. This immutable subject contains the source-bound `bt2_project_read` projection contract and qualification used for currentness reads.
